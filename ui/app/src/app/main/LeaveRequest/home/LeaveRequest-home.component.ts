...
@Component({
  selector: 'LeaveRequest-home',
  templateUrl: './LeaveRequest-home.component.html',
  styleUrls: ['./LeaveRequest-home.component.scss']
})
export class LeaveRequestHomeComponent implements AfterViewInit {
