...
@Component({
  selector: 'EmployeeBenefit-home',
  templateUrl: './EmployeeBenefit-home.component.html',
  styleUrls: ['./EmployeeBenefit-home.component.scss']
})
export class EmployeeBenefitHomeComponent implements AfterViewInit {
