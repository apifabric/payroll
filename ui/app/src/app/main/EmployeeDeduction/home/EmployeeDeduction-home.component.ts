...
@Component({
  selector: 'EmployeeDeduction-home',
  templateUrl: './EmployeeDeduction-home.component.html',
  styleUrls: ['./EmployeeDeduction-home.component.scss']
})
export class EmployeeDeductionHomeComponent implements AfterViewInit {
